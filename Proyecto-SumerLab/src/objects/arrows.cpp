...
namespace Arrows
{
	...
	void Initialize()
	{
		...
		//arrows[0].body.y = 50;
		arrows[0].body.y = static_cast<float>(GetScreenHeight() / 4);
		...
		//arrows[1].body.y = 200;
		arrows[1].body.y = static_cast<float>(GetScreenHeight() / 4 + GetScreenHeight() / 4);
		...
		//arrows[2].body.y = 350;
		arrows[2].body.y = static_cast<float>(GetScreenHeight() / 4 + GetScreenHeight() / 4 + GetScreenHeight() / 4);
